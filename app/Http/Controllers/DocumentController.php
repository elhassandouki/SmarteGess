    ...
    protected function documentsDataTableResponse(Request $request, \Illuminate\Database\Eloquent\Builder $query): JsonResponse
    {
        ...
        $data = $documents->map(function (Document $document) use ($types, $statusMap, $statusThemes) {
            ...
            $actionHtml = '<div class="btn-group btn-group-sm" role="group">'
                ...
                .'<div class="btn-group btn-group-sm mr-2" role="group"><button class="btn btn-xs btn-outline-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-file-pdf"></i></button>'
                .'<div class="dropdown-menu dropdown-menu-right">'
                .'<a class="dropdown-item" href="'.route('invoices.preview', $document).'" target="_blank"><i class="fas fa-eye mr-1"></i> Aperçu</a>'
                .'<a class="dropdown-item" href="'.route('invoices.pdf', $document).'"><i class="fas fa-download mr-1"></i> Télécharger</a>'
                .'</div></div>'
                .'<div class="btn-group btn-group-sm mr-2" role="group"><button class="btn btn-xs btn-outline-warning dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-print"></i></button>'
                .'<div class="dropdown-menu dropdown-menu-right">'
                .'<a class="dropdown-item" href="'.route('invoices.thermal-preview', $document).'" target="_blank"><i class="fas fa-eye mr-1"></i> Aperçu</a>'
                .'<a class="dropdown-item" href="'.route('invoices.thermal', $document).'"><i class="fas fa-print mr-1"></i> Imprimer</a>'
                .'</div></div>'
